...
chihuahua_LIMIT=100 \
chihuahua_URL='https://lcd-chihuahua.cosmostation.io/cosmos/tx/v1beta1/txs?pagination.limit=100&pagination.offset={OFFSET}&events=message.sender%3D%27{WALLET}%27&events=message.action%3D%27{ACTION}%27' \
chihuahua_NODES='https://api.chihuahua.wtf/cosmos/staking/v1beta1/validators?pagination.limit=500' \
cerberus_LIMIT=100 \
cerberus_URL='https://lcd-cerberus.cosmostation.io/cosmos/tx/v1beta1/txs?pagination.limit=100&pagination.offset={OFFSET}&events=message.sender%3D%27{WALLET}%27&events=message.action%3D%27{ACTION}%27' \
