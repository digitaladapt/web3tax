...
# possible values:
# Official Midgard (works just fine)    # https://midgard.thorchain.info/v2/actions?limit=50&address={WALLETS}&offset={OFFSET}
# NineRealms Midgard (gave some issues) # https://midgard.ninerealms.com/v2/actions?limit=50&address={WALLETS}&offset={OFFSET}
